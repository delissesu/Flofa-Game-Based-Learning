...
class Kambing:
    def __init__(self, x, y, name, desc):
        ...
        try:
            ...
            print(f"[ERROR] Gagal load kambing: {e}")
            dummy = pygame.Surface((42, 42))
            dummy.fill((169, 169, 169))
        ...
        self.frame_index = 0
        self.animation_speed = 0.15  # Kambing lincah
        ...
        self.speed = random.uniform(0.7, 1.3)  # Kambing cepat
        self.state = "idle"
        self.move_timer = 0
    ...
    def update_movement(self):
        ...
        if self.state == "walking":
            self.set_animation(self.walk_frames, animation_speed=0.17)
    ...
    def draw(self, surface, camera):
        ...
        if self.highlight:
            pygame.draw.circle(surface, YELLOW, screen_rect.center, 33, 3)
