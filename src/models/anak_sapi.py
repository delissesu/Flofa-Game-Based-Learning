...
class AnakSapi:
    def __init__(self, x, y, name, desc):
        ...
        try:
            ...
            SCALE_FACTOR = 0.45  # Lebih kecil dari sapi dewasa
        ...
        self.frame_index = 0
        self.animation_speed = 0.14  # Lebih cepat dari sapi dewasa
        ...
        self.speed = random.uniform(0.6, 1.2)  # Lebih lincah
        self.state = "idle"
        self.move_timer = 0
    ...
    def update_movement(self):
        ...
        if self.move_timer <= 0:
            ...
            if self.state == "idle":
                if rand_val < 0.6:  # Lebih aktif
                    self.state = "walking"
                    self.move_duration = random.randint(70, 180)
